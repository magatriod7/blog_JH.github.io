...
![restful1](./restful.png)


깊이 들어가면 네트워크에 대해서 들어가야하기 때문에 이 부분은 추후 설명하고 이번에는 간단하게 하고 넘어갈 예정이다.

URI - <span style='background-color:#fff5b1; color:black;'>프로토콜</span> + <span style='color:black; background-color:#ffdce0 '>도메인</span> + <span style=' color:black; background-color:#F7DDBE'>uri</span> 

ex)<span style='color:black; background-color:#fff5b1 '>https:</span>//<span style='color:black; background-color:#ffdce0 '>github.com</span>/<span style='color:black; background-color:#F7DDBE'>posth2071/repository</span> 
